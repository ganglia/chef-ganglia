...
* Host to be monitored. The run_list and attributes for such a host will be something like:
...
* Host that collects metrics for a cluster. The run_list and attributes for such a host would be something like:
